...
import { ImageBackground, Text, View, StyleSheet, ListHeaderComponent } from 'react-native';
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <ImageBackground source={image} resizeMode="cover" style = {styles.image}>
        ...
        <Text style={{ color: '#0093B2', position: "absolute", fontSize: 36, paddingLeft: 1000, paddingTop: 480}}>6% Discount on Chaina, Japan &{"\n"}South Korea</Text>
